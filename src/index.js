...
const UserCard = ({ name, location, foodType, age, likes, twitterUsername, avatar }) => {
	...
	return (
		<div>
			...
			<UserDetail label={labels[0]} value={location} />
			<UserDetail label={labels[1]} value={foodType} />
			<UserDetail label={labels[2]} value={age} />
			<UserDetail label={labels[3]} value={likes} />
			<UserDetail
				label={labels[4]}
				value={
					<a target="_blank" rel="noreferrer" href={twitterLink}>
